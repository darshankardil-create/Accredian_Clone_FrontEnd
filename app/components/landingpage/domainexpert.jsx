  ...
  const DOMAINS = [
    {
      ...
      icon: (
        <svg
          ...
          className="text-blue-600 w-6 h-6 sm:w-14 sm:h-14 mr-2 sm:mr-0 sm:mb-2"
        >
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {DOMAINS.map(({ label, icon }) => (
            <div
              key={label}
              className="domain-card cursor-pointer p-3 w-[45%] sm:w-[28%] flex sm:flex-col justify-center items-center bg-white border border-gray-200 rounded-xl shadow-lg"
            >
              {icon}
              <h3 className="text-[10px] sm:text-base font-semibold text-center text-gray-900">
                {label}
              </h3>
            </div>
          ))}
